    ...
    <aside id="sidebar" class="bg-brand-light text-slate-600 w-72 min-h-[calc(100vh-5rem)] flex flex-col justify-between transition-all duration-300 border-r border-brand-border/60 sticky top-20 h-[calc(100vh-5rem)] z-30 shrink-0 shadow-sm">
      ...
      <div class="flex flex-col h-full overflow-hidden">
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar">
          ...
          <span class="sidebar-text text-[9px] font-bold tracking-widest text-slate-400 uppercase block px-3 mt-4 mb-2">Citizen Information & Engagement</span>
          ...
          <div class="space-y-1">
            ...
            <div id="certificateDropdown" class="<?php echo in_array($currentPage, $certificateIssuancePages) ? '' : 'hidden'; ?> pl-8 pr-2 space-y-0.5 font-medium sidebar-text">
              ...
              <a href="<?php echo $basePath ?? '../'; ?>pages/certificate-issuance/payment-records.php" class="flex items-center space-x-2 px-3 py-2 text-[11px] rounded-md transition <?php echo $currentPage == 'payment-records.php' ? 'text-brand-medium font-black bg-white border border-brand-border/40 shadow-xs' : 'text-slate-500 hover:text-brand-dark'; ?>"><i class="fa-solid fa-receipt text-[10px] <?php echo $currentPage == 'payment-records.php' ? 'text-brand-medium' : 'opacity-50'; ?>"></i> <span>Payment Records</span></a>
            </div>
          </div>
          <?php endif; ?>
